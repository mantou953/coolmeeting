...
<html>
    ...
    <#include 'top.ftl'>
    <div class="page-body">
        <#include 'leftMenus.ftl'>
            <div class="page-content">
                <div class="content-nav">
                    人员管理 > 员工注册
                </div>
                <form action="/doRegister" method="post">
                    <div style="color: #ff0207">${error!''}</div>
                    <fieldset>
                        <legend>员工信息</legend>
                        <table class="formtable" style="width:50%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="confirminfo" style="color: #ff0207"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>联系电话：</td>
                            ...
                            <tr>
                                <td colspan="6" class="command">
                                    <input type="submit" class="clickbutton" value="注册" onclick=oncheck()/>
    ...
    <script>
        function check(){
            ...
            if (password != confirm)
                confirmInfo.innerHTML = "两次密码输入不一样";
            else
